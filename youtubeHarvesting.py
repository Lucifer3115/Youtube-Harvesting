...
with col1:
    st.header(':pink[Data collection zone]')
    ...
    st.write('''Get data and stored it in the MongoDB database to click below **:blue['Get data and stored in MongoDB']**.''')
    ...
    if Get_data or st.session_state.Get_state:
        ...
        api_version = 'v3'
        api_key = 'AIzaSyB0KeD9GPY4T1aug00kGsGLemtHvzch2zs'
        ...
        def get_channel_data(youtube,channel_id):
            try:
                ...
                st.write('You have exceeded your YouTube API request. Please try again tomorrow.')
...
with col2:
    st.header(':pink [Data Migrate zone]')
...
if Check_channel:
   # Create database connection
    ...
    results = pd.read_sql_query(sql=text(query), con=engine)
